...
public class LanguageService {
	...
	public static List<Language> getLanguagesByCity(City city) {
		return getLanguagesByCountry(city.getCountry());
	}

	@SuppressWarnings("unchecked")
	public static List<Language> getLanguagesByCountry(Country country) {
	...
	@SuppressWarnings("unchecked")
	public static List<Object[]> getSortedLanguagesByCountry(Country country) {
		return HibernateSession.get().createCriteria(Language.class, "l").createAlias("countries", "cl")
				.add(Restrictions.eq("cl.countryCode", country.getCode()))
