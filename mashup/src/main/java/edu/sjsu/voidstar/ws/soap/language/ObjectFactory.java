...
public class ObjectFactory {
    ...
    private final static QName _GetSortedLanguagesByCountryResponse_QNAME = new QName("http://ws.voidstar.sjsu.edu/soap/language", "getSortedLanguagesByCountryResponse");
    ...
    private final static QName _GetSortedLanguagesByCountry_QNAME = new QName("http://ws.voidstar.sjsu.edu/soap/language", "getSortedLanguagesByCountry");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.voidstar.sjsu.edu/soap/language", name = "getSortedLanguagesByCountryResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.voidstar.sjsu.edu/soap/language", name = "getSortedLanguagesByCountry")
