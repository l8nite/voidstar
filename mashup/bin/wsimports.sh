 wsimport -verbose -s src/main/java/ -g target/ http://triton.idlemonkeys.net:8080/service-1.0-SNAPSHOT/city?wsdl
 wsimport -verbose -s src/main/java/ -g target/ http://triton.idlemonkeys.net:8080/service-1.0-SNAPSHOT/country?wsdl
