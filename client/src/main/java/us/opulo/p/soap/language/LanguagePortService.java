 ...
 * 
 */
@WebServiceClient(name = "LanguagePortService", targetNamespace = "http://p.opulo.us/soap/language", wsdlLocation = "file:/C:/cygwin/home/jcampos/dev/voidstar/service/src/main/resources/wsdl/LanguageSoapService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "file:/C:/cygwin/home/jcampos/dev/voidstar/service/src/main/resources/wsdl/LanguageSoapService.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/C:/cygwin/home/jcampos/dev/voidstar/service/src/main/resources/wsdl/LanguageSoapService.wsdl', retrying as a local file");
